...
export class LanguageService {
  private translations: any = {
    en: {
      ...
      startStopText: 'Use the main timer button to start or pause the game.',
      addGoalTitle: 'Add Goal',
      addGoalText: 'Tap the ball icon for the scoring team.',
      exclusionTitle: 'Exclusion',
      exclusionText: 'Tap the whistle icon for the team that committed the foul.',
      undoTitle: 'Undo',
      undoText: 'Use the back arrow to revert the last action.',
      settingsTitle: 'Settings',
      settingsText: 'Tap the gear icon to change the language and other options.',
      close: 'Close',
    },
    hr: {
      settings: 'Postavke',
      ...
      startStopTitle: 'Start/Stop',
      startStopText: 'Koristite glavnu tipku za pokretanje ili pauziranje igre.',
      addGoalTitle: 'Dodaj gol',
      addGoalText: 'Dodirnite ikonu lopte za ekipu koja je postigla gol.',
      exclusionTitle: 'Isključenje',
      exclusionText: 'Dodirnite ikonu zviždaljke za ekipu koja je počinila prekršaj.',
      undoTitle: 'Poništi',
      undoText: 'Koristite strelicu za povratak da biste poništili posljednju radnju.',
      settingsTitle: 'Postavke',
      settingsText: 'Dodirnite ikonu zupčanika za promjenu jezika i drugih opcija.',
      close: 'Zatvori',
    }
  };
